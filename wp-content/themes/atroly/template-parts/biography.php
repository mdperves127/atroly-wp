<?php
    ...
    $author_info = get_the_author_meta( 'atroly_write_by');
    $facebook_url = get_the_author_meta( 'atroly_facebook' );
    $twitter_url = get_the_author_meta( 'atroly_twitter' );
    $linkedin_url = get_the_author_meta( 'atroly_linkedin' );
    $instagram_url = get_the_author_meta( 'atroly_instagram' );
    $atroly_url = get_the_author_meta( 'atroly_youtube' );
    $atroly_write_by = get_the_author_meta( 'atroly_write_by' );
