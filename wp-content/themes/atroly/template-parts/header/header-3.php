...
<div class="header-main-area">
    <div class="header header--four" id="header">
        <div class="container position-relative">
            <div class="header-wrapper">
            <?php  if ( !empty( $header_top_phone ) ): ?>
                <div class="menu--wrap d-flex align-items-center gap-2">
                    <!-- ham menu -->
                ...
                <div class="menu--wrap d-flex align-items-center gap--72">
                    ...
                    <?php  if ( !empty( $header_search_switch ) ): ?>
                        <li class="search">
                            <button class="text--black" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-center"
                                aria-controls="offcanvas-center">
                        ...
                        <li class="loin-btn--wrap">
                            <a class="btn btn--base-four btn--lg" href="<?php echo esc_url( $header_top_button_link ); ?>"><?php echo esc_html( $header_top_button_text ); ?></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </div>
            ...
            <!-- single nav menu -->
            <div class="chunk-menu-container">
