<?php 
   ...
   $header_top_button_text = get_theme_mod( 'header_button_text', __( 'Book a Appointment', 'atroly' ) );
...
<div class="header-main-area">
    <div class="header header--six position-relative" id="header">
                ...
                <div class="menu--wrap d-flex align-items-center gap--72">
                    ...
                    <?php  if ( !empty( $header_top_button_switch ) ): ?>
                        <li class="loin-btn--wrap">
                            <a class="btn btn--base-three btn--lg" href="<?php echo esc_url( $header_top_button_link ); ?>"><?php echo esc_html( $header_top_button_text ); ?></a>
                        </li>
                    <?php endif; ?>
                    </ul>
                </div>
