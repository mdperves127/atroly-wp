...
?>
  ...
  <div class="atroly-event-details__area pt-120 pb-120">
      <div class="container">
          <div class="row">
              <div class="col-xl-8 col-lg-8">
                  <div class="atroly-event-details__left-side">
                      <div class="atroly-event-details__thumb p-relative ">
                      <?php the_post_thumbnail(); ?>
                          <div class="atroly-event-details__thumb-text">
                              <span><?php echo esc_html($campaign_single_cat[0]); ?></span>
                          </div>
                      </div>
                      <div class="atroly-donation-details__progress-box grey-bg mb-30">
                          <div class="atroly-donation-details__progress w-100">
                              <div class="atroly-donation-details__progress-item fix">
                                  ...
                                  <div class="progress-goals">
                                      <span><?php echo esc_html__('Raised','atrolycore'); ?> <b> <?php echo $campaign_donated_amount; ?></b></span>
                                      <span><?php echo esc_html__('Goal','atrolycore'); ?> <b> <?php echo $campaign_goal; ?></b></span>
                                  </div>
                              </div>
                          </div>
                      </div>
                      <div class="atroly-donation-content">
                        <?php the_content(); ?>
                      </div>
                      <h4 class="atroly-event-details__title mb-45"><?php echo esc_html__('Donation Form','atrolycore'); ?></h4>
                      <div class="atroly-donation-details__form-box">
              ...
              <?php if ( is_active_sidebar('campaigns-sidebar') ): ?>  
                  <div class="col-lg-4 col-xl-4 mb-30">
                    <div class="atroly-event-details__right-box">
