...
?>
    ...
    <section class="atroly-event-details__area pt-120 pb-65">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8">
                    <div class="atroly-event-details__left-box">
                    <?php if(has_post_thumbnail()) : ?>
                        <div class="atroly-event-details__thumb p-relative pb-25">                   
                            <?php the_post_thumbnail(); ?>
                            <div class="atroly-event-details__thumb-text d-none d-md-block">
                                <span><?php echo esc_html($start_date_day_month); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                        <h4 class="atroly-event-details__title"><?php the_title(); ?></h4>
                        ...
                        <div class="atroly-event-details__text">
                            <?php the_content(); ?>
                        </div>
                    </div>
                </div>
