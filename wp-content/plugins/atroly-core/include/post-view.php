...
function harry_blog_single_social(){
 ...
 ?>    
    <div class="postbox__share text-xl-end">
        ...
        <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo esc_url($post_url);?>" target="_blank"><i class="fab fa-linkedin atroly-linkedin"></i></a>
        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url($post_url);?>" target="_blank""><i class="fab fa-facebook atroly-facebook" ></i></a>
        <a href="https://twitter.com/share?url=<?php echo esc_url($post_url);?>" target="_blank"><i class="fab fa-twitter atroly-twitter"></i></a>
    </div>
   <?php return false;
}
...
function harry_product_single_social(){
 ...
 ?>    
    <div class="product__details-share">
        <span><?php echo esc_html__('Share On:', 'harry');?></span>
        <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo esc_url($post_url);?>" target="_blank"><i class="fab fa-linkedin-in atroly-linkedin"></i></a>
        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url($post_url);?>" target="_blank""><i class="fab fa-facebook-f atroly-facebook" ></i></a>
        <a href="https://twitter.com/share?url=<?php echo esc_url($post_url);?>" target="_blank"><i class="fab fa-twitter atroly-twitter"></i></a>
    </div>
   <?php return false;
}
