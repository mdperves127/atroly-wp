...
function technix_product_social_share(){
    ...
    ?>    
    <div class="atroly-product-details-social">
        <span><?php echo esc_html__('Share:', 'atrolycore'); ?></span>
        ...
        <a href="htatroly://pinterest.com/pin/create/button/?url=<?php echo esc_url($post_url);?>" target="_blank"><i class="fab fa-pinterest-p"></i></a>
