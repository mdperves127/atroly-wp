<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'atroly_subscriber_widget');
	function atroly_subscriber_widget() {
		register_widget('atroly_subscriber_widget');
	}
	
	
	class ATROLY_Subscriber_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('atroly_subscriber_widget',esc_html__('Harry Footer Subscriber','tocore'),array(
