<?php 
Class ATROLY_Services_List_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('atroly-services-list', 'ATROLY Services List', array(
			'description'	=> 'ATROLY Services List'
		));
	}
...
add_action('widgets_init', function(){
	register_widget('ATROLY_Services_List_Widget');
});