<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'atroly_service_sidebar_widget');
	function atroly_service_sidebar_widget() {
		register_widget('atroly_service_sidebar_widget');
	}
	
	
	class atroly_service_sidebar_widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('atroly_service_sidebar_widget',esc_html__('Harry Service Sidebar Contact','tocore'),array(
