<?php 
Class ATROLY_Posts_Footer_IMG_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('atroly-latest-posts-footer-img', 'ATROLY Footer Posts Image', array(
...
add_action('widgets_init', function(){
	register_widget('ATROLY_Posts_Footer_IMG_Widget');
});