<?php
	/**
	 * ATROLYCore Portfolio Info Widget
	 *
	 *
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'atroly_portfolio_info_widget');
	function atroly_portfolio_info_widget() {
		register_widget('atroly_portfolio_info_widget');
	}
	
	
	class atroly_portfolio_info_widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('atroly_portfolio_info_widget',esc_html__('ATROLY Portfolio Info','atrolycore'),array(
				'description' => esc_html__('ATROLY Portfolio Info Widget by creative-hunk','atrolycore'),
			));
		}
