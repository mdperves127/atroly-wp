<?php 
Class ATROLY_Latest_Post_Footer_No_Thumb extends WP_Widget{

	public function __construct(){
		parent::__construct('atroly-latest-posts-footer-no-thumb', 'Atroly Footer Posts No Thumb', array(
			'description'	=> 'Latest Post Widget by Atroly'
		));
	}
...
<div class="atroly-footer-widget-content">
    ...
    <?php 
		...
		?>
    <div class="atroly-footer-widget-item">
        <h4 class="atroly-footer-widget-item-title"> <a
...
add_action('widgets_init', function(){
	register_widget('ATROLY_Latest_Post_Footer_No_Thumb');
});