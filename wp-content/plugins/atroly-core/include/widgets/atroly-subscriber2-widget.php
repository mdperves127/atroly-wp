<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'atroly_subscriber2_widget');
	function atroly_subscriber2_widget() {
		register_widget('atroly_subscriber2_widget');
	}
	
	
	class atroly_subscriber2_widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('atroly_subscriber2_widget',esc_html__('Bizker Footer Subscriber 2','tocore'),array(
		...
		?>
				...
				<div class="atroly-footer-subscribe-area-two position-relative pt-100">
					<div class="container">
						<div class="atroly-footer-subscribe-bg-two theme-yellow-bg pt-30 pb-20 z-index pl-60 pr-60">
							<div class="row align-items-center">
								<div class="col-xl-5 col-lg-4">
									<?php if( !empty($instance['title']) ): ?>
									<div class="atroly-footer-subscribe">
										<h3 class="atroly-footer-subscribe-title"><?php echo apply_filters( 'widget_title', $instance['title'] ); ?></h3>
									</div>
									<?php endif; ?>
								</div>
								<?php if( !empty($mailchimp_shortcode) ): ?>
								<div class="col-xl-7 col-lg-8">
									<div class="atroly-footer-subscribe-form atroly-footer-subscribe-form-2">
