<?php 
Class ATROLY_Latest_Post_Footer_Thumb extends WP_Widget{

	public function __construct(){
		parent::__construct('atroly-latest-posts-footer-thumb', 'Harry Footer Posts Thumb', array(
...
add_action('widgets_init', function(){
	register_widget('ATROLY_Latest_Post_Footer_Thumb');
});