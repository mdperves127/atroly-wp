<?php
	...
	class Softec_offer_Widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('Softec_offer_Widget',esc_html__('Softec :: About (footer)','atrolycore'),array(
				'description' => esc_html__('Softec About Widget For Footer','atrolycore'),
			));
		}
...
<a href="<?php echo esc_url($img_link); ?>" class="atroly-footer__widget-logo mb-10">
    <img src="<?php echo esc_url( $sidebar_offer_img ); ?>" alt="<?php echo esc_attr__('Softec Image', 'atrolycore');?>">
</a>
<?php else : ?>
<img src="<?php echo esc_url( $sidebar_offer_img ); ?>" alt="<?php echo esc_attr__('Softec Image', 'atrolycore');?>">
<?php endif; ?>
<?php endif; ?>
<div class="atroly-footer__text">
    <?php if(!empty($short_description)) : ?>
    <p><?php echo esc_html($short_description); ?></p>
    <?php endif; ?>
</div>
<div class="atroly-footer__social">
...
<!-- img url -->
<p><label for="img_url"><?php esc_html_e('Image Link', 'atrolycore'); ?></label></p>
...
<!-- short description -->
<p><label for="short_description"><?php esc_html_e('Short Description:','atrolycore'); ?></p>
...
<h3><?php esc_html_e('Social Links :', 'atrolycore'); ?></h3>
<hr>

<!-- facebook -->
<p><label for="fb_link"><?php esc_html_e('Facebook Link', 'atrolycore'); ?></label></p>
...
<!-- twitter -->
<p><label for="tw_link"><?php esc_html_e('Twitter Link', 'atrolycore'); ?></label></p>
...
<!-- instagram -->
<p><label for="ig_link"><?php esc_html_e('Instagram Link', 'atrolycore'); ?></label></p>
...
<!-- linkedin -->
<p><label for="ld_link"><?php esc_html_e('Linkedin Link', 'atrolycore'); ?></label></p>
...
<!-- youtube -->
<p><label for="yt_link"><?php esc_html_e('Youtube Link', 'atrolycore'); ?></label></p>
