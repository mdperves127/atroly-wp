<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'atroly_subscriber3_widget');
	function atroly_subscriber3_widget() {
		register_widget('atroly_subscriber3_widget');
	}
	
	
	class ATROLY_Subscriber3_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('atroly_subscriber3_widget',esc_html__('Harry Footer Subscriber 3','tocore'),array(
		...
		?>
							...
							<div class="footer__subscribe-8">
								...
								<div class="footer__social mt-25 atroly-footer-social-orange">
