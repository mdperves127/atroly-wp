...
class ATROLY_El_Woocommerce
{
     ...
     * @static
     *
     * @var AtrolyElement The single instance of the class.
     */
     ...
     *
     * @return AtrolyElement An instance of the class.
     * @since 1.0.0
     *
     * @access public
     * @static
    ...
    public static function atroly_woo_add_to_cart( $args = array() ) {
        global $product;
            ...
            echo sprintf( '<a href="%s" data-quantity="%s" class="%s" %s>%s</a>',
                ...
                '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="htatroly://www.w3.org/2000/svg">
    ...
    // quick view
    public static function gharry_woosq_button_html( $ouatrolyut , $prodid ) {
        return $ouatrolyut = '<a href="#" class="icon-btn woosq-btn woosq-btn-' . esc_attr( $prodid ) . ' ' . get_option( 'woosq_button_class' ) . '" data-id="' . esc_attr( $prodid ) . '" data-effect="mfp-3d-unfold"><svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="htatroly://www.w3.org/2000/svg">
    ...
    public static function add_to_cart_button($product_id)
    {
        ...
        if ($product) {
            ...
            return sprintf('<a rel="nofollow" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s add_to_cart_button atroly-btn"><i class="fal fa-shopping-cart"></i> Add To Cart</a>',
                esc_url($product->add_to_cart_url()),
    ...
    // atroly_vc_product_thumb
    public static function atroly_vc_product_thumb($size = array(370, 425))
    {
        ...
        if (!empty($attachment_ids)) {
            ...
            foreach ($attachment_ids as $attachment_id) {
                ...
                if ($image_attributes[0] != '') {
                    $markup .= '<img class="' . $class . '" src="' . $image_attributes[0] . '" alt="' . esc_html__('image', 'atroly-woocommerce') . '" >';
                }
                $i++;
            }
            $markup .= '</a>';
    ...
    public static function atroly_vc_loop_product_thumb()
    {
...
ATROLY_El_Woocommerce::instance();